package com.stonewu.aifusion.module.erp.controller.admin.stock.vo.out;
...
import com.stonewu.aifusion.module.erp.enums.DictTypeConstants;
...
public class ErpStockOutRespVO {
    ...
    @Schema(description = "客户名称", example = "AI-Fusion")
    @ExcelProperty("客户名称")
    ...
    @Schema(description = "创建人名称", example = "AI-Fusion")
