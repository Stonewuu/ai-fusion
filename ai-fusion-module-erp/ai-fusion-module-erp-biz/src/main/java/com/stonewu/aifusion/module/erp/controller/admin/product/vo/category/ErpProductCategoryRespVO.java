package com.stonewu.aifusion.module.erp.controller.admin.product.vo.category;
...
public class ErpProductCategoryRespVO {
    ...
    @Schema(description = "分类名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "aifusion")
    @ExcelProperty("分类名称")
    private String name;
