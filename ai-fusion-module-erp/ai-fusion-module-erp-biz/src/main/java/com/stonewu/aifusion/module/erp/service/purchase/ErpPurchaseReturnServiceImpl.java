...
import com.stonewu.aifusion.module.erp.controller.admin.purchase.vo.returns.ErpPurchaseReturnPageReqVO;
import com.stonewu.aifusion.module.erp.controller.admin.purchase.vo.returns.ErpPurchaseReturnSaveReqVO;
...
import com.stonewu.aifusion.module.erp.dal.mysql.purchase.ErpPurchaseReturnItemMapper;
import com.stonewu.aifusion.module.erp.dal.mysql.purchase.ErpPurchaseReturnMapper;
import com.stonewu.aifusion.module.erp.dal.redis.no.ErpNoRedisDAO;
import com.stonewu.aifusion.module.erp.enums.ErpAuditStatus;
import com.stonewu.aifusion.module.erp.enums.ErrorCodeConstants;
import com.stonewu.aifusion.module.erp.enums.stock.ErpStockRecordBizTypeEnum;
import com.stonewu.aifusion.module.erp.service.finance.ErpAccountService;
import com.stonewu.aifusion.module.erp.service.product.ErpProductService;
import com.stonewu.aifusion.module.erp.service.stock.ErpStockRecordService;
import com.stonewu.aifusion.module.erp.service.stock.bo.ErpStockRecordCreateReqBO;
...
public class ErpPurchaseReturnServiceImpl implements ErpPurchaseReturnService {
    ...
    public Long createPurchaseReturn(ErpPurchaseReturnSaveReqVO createReqVO) {
        ...
        if (purchaseReturnMapper.selectByNo(no) != null) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.PURCHASE_RETURN_NO_EXISTS);
        }
    ...
    public void updatePurchaseReturn(ErpPurchaseReturnSaveReqVO updateReqVO) {
        ...
        if (ErpAuditStatus.APPROVE.getStatus().equals(purchaseReturn.getStatus())) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.PURCHASE_RETURN_UPDATE_FAIL_APPROVE, purchaseReturn.getNo());
        }
        // 1.2 校验采购订单已审核
    ...
    public void updatePurchaseReturnStatus(Long id, Integer status) {
        ...
        if (purchaseReturn.getStatus().equals(status)) {
            throw ServiceExceptionUtil.exception(approve ? ErrorCodeConstants.PURCHASE_RETURN_APPROVE_FAIL : ErrorCodeConstants.PURCHASE_RETURN_PROCESS_FAIL);
        }
        // 1.3 校验已退款
        if (!approve && purchaseReturn.getRefundPrice().compareTo(BigDecimal.ZERO) > 0) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.PURCHASE_RETURN_PROCESS_FAIL_EXISTS_REFUND);
        }
    ...
    public void updatePurchaseReturnRefundPrice(Long id, BigDecimal refundPrice) {
        ...
        if (refundPrice.compareTo(purchaseReturn.getTotalPrice()) > 0) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.PURCHASE_RETURN_FAIL_REFUND_PRICE_EXCEED, refundPrice, purchaseReturn.getTotalPrice());
        }
    ...
    public void deletePurchaseReturn(List<Long> ids) {
        ...
        purchaseReturns.forEach(purchaseReturn -> {
            if (ErpAuditStatus.APPROVE.getStatus().equals(purchaseReturn.getStatus())) {
                throw ServiceExceptionUtil.exception(ErrorCodeConstants.PURCHASE_RETURN_DELETE_FAIL_APPROVE, purchaseReturn.getNo());
            }
        });
    ...
    private ErpPurchaseReturnDO validatePurchaseReturnExists(Long id) {
        ...
        if (purchaseReturn == null) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.PURCHASE_RETURN_NOT_EXISTS);
        }
    ...
    public ErpPurchaseReturnDO validatePurchaseReturn(Long id) {
        ...
        if (ObjectUtil.notEqual(purchaseReturn.getStatus(), ErpAuditStatus.APPROVE.getStatus())) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.PURCHASE_RETURN_NOT_APPROVE);
        }
        return purchaseReturn;
    }
