package com.stonewu.aifusion.module.infra.controller.admin.logger.vo.apierrorlog;
...
public class ApiErrorLogRespVO {
    ...
    @DictFormat(com.stonewu.aifusion.module.system.enums.DictTypeConstants.USER_TYPE)
