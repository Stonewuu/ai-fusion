package com.stonewu.aifusion.module.infra.service.codegen.inner;
...
import com.stonewu.aifusion.framework.apilog.core.enums.OperateTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "ai-fusion-module-${table.moduleName}/" + // 顶级模块
                "ai-fusion-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "ai-fusion-module-${table.moduleName}/" + // 顶级模块
                "ai-fusion-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "ai-fusion-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "ai-fusion-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
