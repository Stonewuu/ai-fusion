package com.stonewu.aifusion.module.infra.service.logger;
...
import com.stonewu.aifusion.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.stonewu.aifusion.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.stonewu.aifusion.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.stonewu.aifusion.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.stonewu.aifusion.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.stonewu.aifusion.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("ai-fusion-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("ai-fusion-test");
