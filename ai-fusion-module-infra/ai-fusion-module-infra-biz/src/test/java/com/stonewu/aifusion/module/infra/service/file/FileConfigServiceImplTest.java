package com.stonewu.aifusion.module.infra.service.file;
...
import com.stonewu.aifusion.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
...
import com.stonewu.aifusion.module.infra.dal.mysql.file.FileConfigMapper;
...
import com.stonewu.aifusion.module.infra.framework.file.core.enums.FileStorageEnum;
...
import static com.stonewu.aifusion.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.stonewu.aifusion.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("AiFusion")
