package com.stonewu.aifusion.module.system.controller.admin.user.vo.profile;
...
public class UserProfileRespVO {
    ...
    @Schema(description = "用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "AI-Fusion")
