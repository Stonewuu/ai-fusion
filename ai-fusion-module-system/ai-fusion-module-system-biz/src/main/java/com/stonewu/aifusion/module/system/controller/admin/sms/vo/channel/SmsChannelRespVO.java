package com.stonewu.aifusion.module.system.controller.admin.sms.vo.channel;
...
public class SmsChannelRespVO {
    ...
    @Schema(description = "短信签名", requiredMode = Schema.RequiredMode.REQUIRED, example = "AiFusion")
    ...
    @Schema(description = "短信发送回调 URL", example = "https://www.stonewu.com")
