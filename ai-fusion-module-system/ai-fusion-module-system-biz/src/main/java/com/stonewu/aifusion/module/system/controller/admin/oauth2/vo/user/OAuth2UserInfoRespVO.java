package com.stonewu.aifusion.module.system.controller.admin.oauth2.vo.user;
...
public class OAuth2UserInfoRespVO {
    ...
    @Schema(description = "用户账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "AI-Fusion")
