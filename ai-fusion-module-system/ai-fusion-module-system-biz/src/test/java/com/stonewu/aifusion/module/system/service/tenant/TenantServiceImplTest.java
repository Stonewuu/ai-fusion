package com.stonewu.aifusion.module.system.service.tenant;

import com.stonewu.aifusion.framework.common.enums.CommonStatusEnum;
import com.stonewu.aifusion.framework.common.pojo.PageResult;
import com.stonewu.aifusion.framework.tenant.config.TenantProperties;
...
import com.stonewu.aifusion.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import com.stonewu.aifusion.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import com.stonewu.aifusion.module.system.dal.dataobject.permission.MenuDO;
import com.stonewu.aifusion.module.system.dal.dataobject.permission.RoleDO;
import com.stonewu.aifusion.module.system.dal.dataobject.tenant.TenantDO;
import com.stonewu.aifusion.module.system.dal.dataobject.tenant.TenantPackageDO;
import com.stonewu.aifusion.module.system.dal.mysql.tenant.TenantMapper;
import com.stonewu.aifusion.module.system.enums.permission.RoleCodeEnum;
import com.stonewu.aifusion.module.system.enums.permission.RoleTypeEnum;
import com.stonewu.aifusion.module.system.service.permission.MenuService;
import com.stonewu.aifusion.module.system.service.permission.PermissionService;
import com.stonewu.aifusion.module.system.service.permission.RoleService;
import com.stonewu.aifusion.module.system.service.tenant.handler.TenantInfoHandler;
import com.stonewu.aifusion.module.system.service.tenant.handler.TenantMenuHandler;
...
import static com.stonewu.aifusion.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("AI-Fusion", user.getNickname());
        ...
        TenantSaveReqVO reqVO = randomPojo(TenantSaveReqVO.class, o -> {
            o.setContactName("AI-Fusion");
            o.setContactMobile("15601691300");
            o.setPackageId(100L);
            o.setStatus(randomCommonStatus());
            o.setWebsite("https://www.stonewu.com");
            o.setUsername("yunai");
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("AI-Fusion"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("AI-Fusion");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
    ...
    public void testGetTenantByWebsite() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setWebsite("https://www.stonewu.com"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByWebsite("https://www.stonewu.com");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
