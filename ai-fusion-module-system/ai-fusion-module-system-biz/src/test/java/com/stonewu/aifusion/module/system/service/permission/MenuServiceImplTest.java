...
import com.stonewu.aifusion.module.system.controller.admin.permission.vo.menu.MenuListReqVO;
import com.stonewu.aifusion.module.system.controller.admin.permission.vo.menu.MenuSaveVO;
import com.stonewu.aifusion.module.system.dal.dataobject.permission.MenuDO;
import com.stonewu.aifusion.module.system.dal.mysql.permission.MenuMapper;
import com.stonewu.aifusion.module.system.enums.permission.MenuTypeEnum;
...
import static com.stonewu.aifusion.module.system.dal.dataobject.permission.MenuDO.ID_ROOT;
...
public class MenuServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMenuList() {
        // mock 数据
        MenuDO menuDO = randomPojo(MenuDO.class, o -> o.setName("AI-Fusion").setStatus(CommonStatusEnum.ENABLE.getStatus()));
        menuMapper.insert(menuDO);
        // 测试 status 不匹配
