package com.stonewu.aifusion.module.system.controller.admin.oauth2;
...
import com.stonewu.aifusion.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import com.stonewu.aifusion.module.system.service.oauth2.OAuth2ApproveService;
import com.stonewu.aifusion.module.system.service.oauth2.OAuth2ClientService;
import com.stonewu.aifusion.module.system.service.oauth2.OAuth2GrantService;
import com.stonewu.aifusion.module.system.service.oauth2.OAuth2TokenService;
...
import static com.stonewu.aifusion.framework.test.core.util.RandomUtils.randomString;
...
public class OAuth2OpenControllerTest extends BaseMockitoUnitTest {
    ...
    public void testApproveOrDeny_ApproveNo() {
        ...
        String clientId = randomString();
        String scope = "{\"read\": true, \"write\": false}";
        String redirectUri = "https://www.stonewu.com";
        String state = "test";
        // mock 方法
        OAuth2ClientDO client = randomPojo(OAuth2ClientDO.class);
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://www.stonewu.com#error=access_denied&error_description=User%20denied%20access&state=test", result.getData());
    }
    ...
    public void testApproveOrDeny_autoApproveWithToken() {
        ...
        assertThat(result.getData(), anyOf( // 29 和 30 都有一定概率，主要是时间计算
                is("https://www.stonewu.com#access_token=test_access_token&token_type=bearer&state=test&expires_in=29&scope=read"),
                is("https://www.stonewu.com#access_token=test_access_token&token_type=bearer&state=test&expires_in=30&scope=read")
        ));
    }
    ...
    public void testApproveOrDeny_approveWithCode() {
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://www.stonewu.com?code=test_code&state=test", result.getData());
    }
