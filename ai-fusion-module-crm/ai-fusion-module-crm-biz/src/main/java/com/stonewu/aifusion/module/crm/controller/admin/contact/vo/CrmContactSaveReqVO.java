package com.stonewu.aifusion.module.crm.controller.admin.contact.vo;
...
import com.stonewu.aifusion.module.crm.framework.operatelog.core.*;
...
public class CrmContactSaveReqVO {
    ...
    @Schema(description = "姓名", example = "aifusion")
