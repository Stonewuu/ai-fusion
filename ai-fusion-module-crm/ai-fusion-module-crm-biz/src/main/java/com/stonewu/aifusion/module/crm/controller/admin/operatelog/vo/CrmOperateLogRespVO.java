package com.stonewu.aifusion.module.crm.controller.admin.operatelog.vo;
...
public class CrmOperateLogRespVO {
    ...
    @Schema(description = "编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "aifusion")
