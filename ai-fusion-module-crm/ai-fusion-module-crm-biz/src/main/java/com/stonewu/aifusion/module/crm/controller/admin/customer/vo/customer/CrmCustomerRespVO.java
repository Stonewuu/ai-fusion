...
public class CrmCustomerRespVO {
    ...
    @DictFormat(com.stonewu.aifusion.module.crm.enums.DictTypeConstants.CRM_CUSTOMER_INDUSTRY)
    private Integer industryId;

    @Schema(description = "客户等级", requiredMode = Schema.RequiredMode.REQUIRED, example = "13563")
    @ExcelProperty(value = "客户等级", converter = DictConvert.class)
    @DictFormat(com.stonewu.aifusion.module.crm.enums.DictTypeConstants.CRM_CUSTOMER_LEVEL)
    ...
    @Schema(description = "创建人名字", example = "AiFusion")
    @ExcelProperty("创建人名字")
