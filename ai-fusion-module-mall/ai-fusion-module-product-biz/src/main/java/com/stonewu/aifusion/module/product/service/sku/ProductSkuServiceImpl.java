package com.stonewu.aifusion.module.product.service.sku;
...
import com.stonewu.aifusion.module.product.convert.sku.ProductSkuConvert;
import com.stonewu.aifusion.module.product.dal.dataobject.property.ProductPropertyDO;
...
import com.stonewu.aifusion.module.product.dal.mysql.sku.ProductSkuMapper;
...
public class ProductSkuServiceImpl implements ProductSkuService {
    ...
    public void updateSkuList(Long spuId, List<ProductSkuSaveReqVO> skus) {
        // 构建属性与 SKU 的映射关系;
        Map<String, Long> existsSkuMap = CollectionUtils.convertMap(productSkuMapper.selectListBySpuId(spuId),
