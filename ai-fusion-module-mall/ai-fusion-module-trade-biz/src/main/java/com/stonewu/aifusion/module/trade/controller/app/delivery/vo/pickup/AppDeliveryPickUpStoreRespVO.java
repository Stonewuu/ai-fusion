package com.stonewu.aifusion.module.trade.controller.app.delivery.vo.pickup;
...
public class AppDeliveryPickUpStoreRespVO {
    ...
    @Schema(description = "门店 logo", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.stonewu.com/1.png")
    private String logo;
