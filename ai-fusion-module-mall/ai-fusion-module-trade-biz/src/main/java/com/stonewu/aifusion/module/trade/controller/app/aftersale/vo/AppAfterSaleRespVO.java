package com.stonewu.aifusion.module.trade.controller.app.aftersale.vo;
...
public class AppAfterSaleRespVO {
    ...
    @Schema(description = "商品图片", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.stonewu.com/01.jpg")
