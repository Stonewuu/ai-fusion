...
import com.stonewu.aifusion.module.promotion.enums.ErrorCodeConstants;
...
import com.stonewu.aifusion.module.promotion.enums.common.PromotionTypeEnum;
import com.stonewu.aifusion.module.trade.enums.order.TradeOrderTypeEnum;
...
import static com.stonewu.aifusion.framework.common.util.collection.CollectionUtils.filterList;
import static com.stonewu.aifusion.module.trade.enums.ErrorCodeConstants.PRICE_CALCULATE_COUPON_NOT_MATCH_NORMAL_ORDER;
...
public class TradeCouponPriceCalculator implements TradePriceCalculator {
    ...
    public void calculate(TradePriceCalculateReqBO param, TradePriceCalculateRespBO result) {
        ...
        if (CollUtil.isEmpty(orderItems)) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.COUPON_NO_MATCH_SPU);
        }
        // 2.2 计算是否满足优惠劵的使用金额
        Integer totalPayPrice = TradePriceCalculatorHelper.calculateTotalPayPrice(orderItems);
        if (totalPayPrice < coupon.getUsePrice()) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.COUPON_NO_MATCH_MIN_PRICE);
        }
