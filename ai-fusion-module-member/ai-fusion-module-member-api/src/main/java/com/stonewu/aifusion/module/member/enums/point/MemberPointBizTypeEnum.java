package com.stonewu.aifusion.module.member.enums.point;

import cn.hutool.core.util.EnumUtil;
import com.stonewu.aifusion.framework.common.core.IntArrayValuable;
...
public enum MemberPointBizTypeEnum implements IntArrayValuable {
    ...
    TOKEN_USE(31, "对话token消耗", "对话使用 {} 积分", false), // 下单时，扣减积分
    ;
