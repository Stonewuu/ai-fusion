package com.stonewu.aifusion.module.member.controller.admin.user.vo;
...
public class MemberUserBaseVO {
    ...
    @Schema(description = "头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.stonewu.com/x.png")
