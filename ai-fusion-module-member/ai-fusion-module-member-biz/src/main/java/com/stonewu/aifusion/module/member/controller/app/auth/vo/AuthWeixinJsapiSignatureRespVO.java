package com.stonewu.aifusion.module.member.controller.app.auth.vo;
...
public class AuthWeixinJsapiSignatureRespVO {
    ...
    @Schema(description = "URL", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.stonewu.com")
    private String url;
