...
![架构演进](/.image/common/ai-fusion-roadmap.png)
...
| [ai-fusion-cloud](https://gitee.com/zhijiantianya/ai-fusion-cloud)      | [![Gitee star](https://gitee.com/zhijiantianya/ai-fusion-cloud/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/ai-fusion-cloud) [![GitHub stars](https://img.shields.io/github/stars/YunaiV/ai-fusion-cloud.svg?style=social&label=Stars)](https://github.com/YunaiV/ai-fusion-cloud)               | 基于 Spring Cloud 微服务架构       |
| [Spring-Boot-Labs](https://gitee.com/yudaocode/SpringBoot-Labs) | [![Gitee star](https://gitee.com/yudaocode/SpringBoot-Labs/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/ai-fusion-cloud) [![GitHub stars](https://img.shields.io/github/stars/yudaocode/SpringBoot-Labs.svg?style=social&label=Stars)](https://github.com/yudaocode/SpringBoot-Labs) | 系统学习 Spring Boot & Cloud 专栏 |

### 前端项目

| 项目                                                                         | Star                                                                                                                                                                                                                                                                                                                     | 简介                                     |
|----------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|
| [ai-fusion-ui-admin-vue3](https://gitee.com/yudaocode/ai-fusion-ui-admin-vue3)     | [![Gitee star](https://gitee.com/yudaocode/ai-fusion-ui-admin-vue3/badge/star.svg?theme=white)](https://gitee.com/yudaocode/ai-fusion-ui-admin-vue3) [![GitHub stars](https://img.shields.io/github/stars/yudaocode/ai-fusion-ui-admin-vue3.svg?style=social&label=Stars)](https://github.com/yudaocode/ai-fusion-ui-admin-vue3)         | 基于 Vue3 + element-plus 实现的管理后台         |
| [ai-fusion-ui-admin-vben](https://gitee.com/yudaocode/ai-fusion-ui-admin-vben)     | [![Gitee star](https://gitee.com/yudaocode/ai-fusion-ui-admin-vben/badge/star.svg?theme=white)](https://gitee.com/yudaocode/ai-fusion-ui-admin-vben) [![GitHub stars](https://img.shields.io/github/stars/yudaocode/ai-fusion-ui-admin-vben.svg?style=social&label=Stars)](https://github.com/yudaocode/ai-fusion-ui-admin-vben)         | 基于 Vue3 + vben(ant-design-vue) 实现的管理后台 |
| [ai-fusion-mall-uniapp](https://gitee.com/yudaocode/ai-fusion-mall-uniapp)         | [![Gitee star](https://gitee.com/yudaocode/ai-fusion-mall-uniapp/badge/star.svg?theme=white)](https://gitee.com/yudaocode/ai-fusion-mall-uniapp) [![GitHub stars](https://img.shields.io/github/stars/yudaocode/ai-fusion-mall-uniapp.svg?style=social&label=Stars)](https://github.com/yudaocode/ai-fusion-mall-uniapp)                 | 基于 uni-app 实现的商城小程序                    |
| [ai-fusion-ui-admin-vue2](https://gitee.com/yudaocode/ai-fusion-ui-admin-vue2)     | [![Gitee star](https://gitee.com/yudaocode/ai-fusion-ui-admin-vue2/badge/star.svg?theme=white)](https://gitee.com/yudaocode/ai-fusion-ui-admin-vue2) [![GitHub stars](https://img.shields.io/github/stars/yudaocode/ai-fusion-ui-admin-vue2.svg?style=social&label=Stars)](https://github.com/yudaocode/ai-fusion-ui-admin-vue2)         | 基于 Vue2 + element-ui 实现的管理后台           |
| [ai-fusion-ui-admin-uniapp](https://gitee.com/yudaocode/ai-fusion-ui-admin-uniapp) | [![Gitee star](https://gitee.com/yudaocode/ai-fusion-ui-admin-uniapp/badge/star.svg?theme=white)](https://gitee.com/yudaocode/ai-fusion-ui-admin-uniapp) [![GitHub stars](https://img.shields.io/github/stars/yudaocode/ai-fusion-ui-admin-uniapp.svg?style=social&label=Stars)](https://github.com/yudaocode/ai-fusion-ui-admin-uniapp) | 基于 Vue2 + element-ui 实现的管理后台           |
| [ai-fusion-ui-go-view](https://gitee.com/yudaocode/ai-fusion-ui-go-view)           | [![Gitee star](https://gitee.com/yudaocode/ai-fusion-ui-go-view/badge/star.svg?theme=white)](https://gitee.com/yudaocode/ai-fusion-ui-go-view) [![GitHub stars](https://img.shields.io/github/stars/yudaocode/ai-fusion-ui-go-view.svg?style=social&label=Stars)](https://github.com/yudaocode/ai-fusion-ui-go-view)                     | 基于 Vue3 + naive-ui 实现的大屏报表             |
...
* JDK 8 + Spring Boot 2.7.18 版本：<https://gitee.com/yudaocode/ai-fusion-boot-mini> 的 `master` 分支
* JDK 21 + Spring Boot 3.2.0 版本：<https://gitee.com/yudaocode/ai-fusion-boot-mini> 的 `master-jdk21` 分支
...
| 项目                    | 说明                 |
|-----------------------|--------------------|
| `ai-fusion-dependencies`  | Maven 依赖版本管理       |
| `ai-fusion-framework`     | Java 框架拓展          |
| `ai-fusion-server`        | 管理后台 + 用户 APP 的服务端 |
| `ai-fusion-module-system` | 系统功能的 Module 模块    |
| `ai-fusion-module-member` | 会员中心的 Module 模块    |
| `ai-fusion-module-infra`  | 基础设施的 Module 模块    |
| `ai-fusion-module-bpm`    | 工作流程的 Module 模块    |
| `ai-fusion-module-pay`    | 支付系统的 Module 模块    |
| `ai-fusion-module-mall`   | 商城系统的 Module 模块    |
| `ai-fusion-module-erp`    | ERP 系统的 Module 模块  |
| `ai-fusion-module-crm`    | CRM 系统的 Module 模块  |
| `ai-fusion-module-mp`     | 微信公众号的 Module 模块   |
| `ai-fusion-module-report` | 大屏报表 Module 模块     |
