...
VALUES (4, '数据库', 1, '我是数据库', 'f',
        '{"@class":"com.stonewu.aifusion.framework.file.core.client.db.DBFileClientConfig","domain":"http://127.0.0.1:48080"}',
        '1', '2022-03-15 23:56:24', '1', '2022-03-26 21:39:26', 0);
INSERT INTO "infra_file_config" ("id", "name", "storage", "remark", "master", "config", "creator", "create_time",
                                 "updater", "update_time", "deleted")
VALUES (5, '本地磁盘', 10, '测试下本地存储', 'f',
        '{"@class":"com.stonewu.aifusion.framework.file.core.client.local.LocalFileClientConfig","basePath":"/Users/yunai/file_test","domain":"http://127.0.0.1:48080"}',
        '1', '2022-03-15 23:57:00', '1', '2022-03-26 21:39:26', 0);
INSERT INTO "infra_file_config" ("id", "name", "storage", "remark", "master", "config", "creator", "create_time",
                                 "updater", "update_time", "deleted")
VALUES (11, 'S3 - 七牛云', 20, NULL, 't',
        '{"@class":"com.stonewu.aifusion.framework.file.core.client.s3.S3FileClientConfig","endpoint":"s3-cn-south-1.qiniucs.com","domain":"http://test.yudao.iocoder.cn","bucket":"ruoyi-vue-pro","accessKey":"b7yvuhBSAGjmtPhMFcn9iMOxUOY_I06cA_p0ZUx8","accessSecret":"kXM1l5ia1RvSX3QaOEcwI3RLz3Y2rmNszWonKZtP"}',
...
VALUES ('schedulerName', 'userSessionTimeoutJob', 'DEFAULT', NULL,
        'handler.core.quartz.com.stonewu.aifusion.framework.JobHandlerInvoker', 'f', 't', 't', 'f',
...
VALUES (100, 'AiFusion', 0, 0, 1, '15888888888', 'ry@qq.com', 0, 'admin', '2021-01-05 17:03:47', '103',
...
VALUES (1, 'default', 'admin123', 'AiFusion', 'http://test.yudao.iocoder.cn/a5e2e244368878a366b516805a4aabf1.png',
...
INSERT INTO "system_tenant" ("id", "name", "contact_user_id", "contact_name", "contact_mobile", "status", "website",
                             ...
                             "update_time", "deleted")
VALUES (1, 'AiFusion', NULL, '芋艿', '17321315478', 0, 'https://www.iocoder.cn', 0, '2099-02-19 17:14:16', 9999, '1',
...
INSERT INTO "system_users" ("id", "username", "password", "nickname", "remark", "dept_id", "post_ids", "email",
                            "mobile", "sex", "avatar", "status", "login_ip", "login_date", "creator", "create_time",
                            "updater", "update_time", "deleted", "tenant_id")
VALUES (1, 'admin', '$2a$10$0acJOIk2D25/oC87nyclE..0lzeu9DtQ/n3geP4fkun/zIVRhHJIO', 'AiFusion', '管理员', 103, '[1]',
