...
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'ERP 采购入库表';
...
CREATE TABLE `erp_purchase_in_items`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'ERP 销售入库项表';
...
CREATE TABLE `erp_purchase_order`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `no`(`no` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'ERP 采购订单表';
...
CREATE TABLE `erp_purchase_order_items`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'ERP 采购订单项表';
...
CREATE TABLE `erp_purchase_return`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `no`(`no` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'ERP 采购退货表';
...
CREATE TABLE `erp_purchase_return_items`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 45 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'ERP 采购退货项表';
...
CREATE TABLE `erp_sale_order`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `no`(`no` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'ERP 销售订单表';

-- ----------------------------
-- Records of erp_sale_order
-- ----------------------------
BEGIN;
INSERT INTO `erp_sale_order` (`id`, `no`, `status`, `customer_id`, `account_id`, `sale_user_id`, `order_time`, `total_count`, `total_price`, `total_product_price`, `total_tax_price`, `discount_percent`, `discount_price`, `deposit_price`, `file_url`, `remark`, `out_count`, `return_count`, `creator`, `create_time`, `updater`, `update_time`, `deleted`, `tenant_id`) VALUES (1, 'Q11', 10, 1, 1, 1, '2024-02-09 20:38:34', 10.000000, 20.000000, 30.000000, 40.000000, 50.000000, 60.000000, 70.000000, NULL, NULL, 9.000000, 0.000000, '1', '2024-02-09 12:38:51', '', '2024-02-11 13:46:42', b'1', 1);
COMMIT;
...
CREATE TABLE `erp_sale_order_items`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'ERP 销售订单项表';

-- ----------------------------
-- Records of erp_sale_order_items
-- ----------------------------
BEGIN;
INSERT INTO `erp_sale_order_items` (`id`, `order_id`, `product_id`, `product_unit_id`, `product_price`, `count`, `total_price`, `tax_percent`, `tax_price`, `remark`, `out_count`, `return_count`, `creator`, `create_time`, `updater`, `update_time`, `deleted`, `tenant_id`) VALUES (1, 1, 1, 1, 10.000000, 30.000000, 40.000000, 50.000000, 60.000000, NULL, 1.000000, 0.000000, '', '2024-02-09 13:00:21', '', '2024-02-10 14:01:01', b'1', 1);
COMMIT;
...
CREATE TABLE `erp_sale_out`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `no`(`no` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'ERP 销售出库表';

-- ----------------------------
-- Records of erp_sale_out
-- ----------------------------
BEGIN;
INSERT INTO `erp_sale_out` (`id`, `no`, `status`, `customer_id`, `account_id`, `sale_user_id`, `out_time`, `order_id`, `order_no`, `total_count`, `total_price`, `receipt_price`, `total_product_price`, `total_tax_price`, `discount_percent`, `discount_price`, `other_price`, `file_url`, `remark`, `creator`, `create_time`, `updater`, `update_time`, `deleted`, `tenant_id`) VALUES (10, 'XSDD20240211000007', 10, 1, 1, NULL, '2024-02-13 00:00:00', 2, 'XSDD20240210000004', 1.000000, -30.510000, 13.000000, 3.360000, 0.030000, 10.000000, 33.900000, 10.000000, NULL, '我测试备注', '1', '2024-02-11 20:17:23', '1', '2024-02-11 13:17:45', b'1', 1), (11, 'XSDD20240211000001', 10, 2, 1, NULL, '2024-02-13 00:00:00', 3, 'XSDD20240211000001', 31.000000, -8400.420000, 85.710000, 512.200000, 421.180000, 10.000000, 9333.800000, 0.000000, NULL, '我测试备注', '1', '2024-02-11 20:58:37', '1', '2024-02-11 13:03:21', b'1', 1), (12, 'XSCK20240211000001', 10, 2, 1, NULL, '2024-02-06 00:00:00', 3, 'XSDD20240211000001', 50.000000, 116.080000, 100.000000, 139.000000, 6.100000, 20.000000, 29.020000, 0.000000, NULL, '我测试备注', '1', '2024-02-11 21:49:02', '1', '2024-02-11 22:42:42', b'1', 1);
COMMIT;
...
CREATE TABLE `erp_sale_out_items`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 27 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'ERP 销售出库项表';

-- ----------------------------
-- Records of erp_sale_out_items
-- ----------------------------
BEGIN;
INSERT INTO `erp_sale_out_items` (`id`, `out_id`, `order_item_id`, `warehouse_id`, `product_id`, `product_unit_id`, `product_price`, `count`, `total_price`, `tax_percent`, `tax_price`, `remark`, `creator`, `create_time`, `updater`, `update_time`, `deleted`, `tenant_id`) VALUES (15, 10, 3, 2, 1, 2, 2.120000, 12.000000, 101.760000, 3.000000, 76.320000, NULL, '1', '2024-02-11 20:17:23', '1', '2024-02-11 13:10:22', b'1', 1), (16, 10, 4, 2, 2, 2, 3.220000, 7.000000, 135.240000, 5.000000, 112.700000, NULL, '1', '2024-02-11 20:17:23', '1', '2024-02-11 13:10:22', b'1', 1), (17, 11, 3, 2, 1, 2, 2.120000, 8.000000, 67.840000, 3.000000, 50.880000, NULL, '1', '2024-02-11 20:58:37', '1', '2024-02-11 13:03:21', b'1', 1), (18, 11, 4, 2, 2, 2, 3.220000, 23.000000, 444.360000, 5.000000, 370.300000, NULL, '1', '2024-02-11 20:58:37', '1', '2024-02-11 13:03:21', b'1', 1), (20, 10, 2, 2, 1, 2, 3.330000, 1.000000, 3.360000, 0.010000, 0.030000, NULL, '1', '2024-02-11 21:10:23', '1', '2024-02-11 13:17:45', b'1', 1), (21, 12, 3, 2, 1, 2, 2.120000, 20.000000, 42.400000, 3.000000, 1.270000, NULL, '1', '2024-02-11 21:49:02', '1', '2024-02-11 22:42:42', b'1', 1), (22, 12, 4, 2, 2, 2, 3.220000, 30.000000, 96.600000, 5.000000, 4.830000, NULL, '1', '2024-02-11 21:49:02', '1', '2024-02-11 22:42:42', b'1', 1);
COMMIT;
...
CREATE TABLE `erp_sale_return`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `no`(`no` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'ERP 销售退货表';

-- ----------------------------
-- Records of erp_sale_return
-- ----------------------------
BEGIN;
INSERT INTO `erp_sale_return` (`id`, `no`, `status`, `customer_id`, `account_id`, `sale_user_id`, `return_time`, `order_id`, `order_no`, `total_count`, `total_price`, `refund_price`, `total_product_price`, `total_tax_price`, `discount_percent`, `discount_price`, `other_price`, `file_url`, `remark`, `creator`, `create_time`, `updater`, `update_time`, `deleted`, `tenant_id`) VALUES (12, 'XSTH20240211000001', 10, 2, 1, NULL, '2024-02-06 00:00:00', 3, 'XSDD20240211000001', 50.000000, 116.080000, 100.000000, 139.000000, 6.100000, 20.000000, 29.020000, 0.000000, NULL, '我测试备注', '1', '2024-02-11 21:49:02', '1', '2024-02-11 22:46:37', b'1', 1);
COMMIT;
...
CREATE TABLE `erp_sale_return_items`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 43 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'ERP 销售退货项表';
...
CREATE TABLE `erp_stock`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'ERP 产品库存表';
...
CREATE TABLE `erp_stock_check`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'ERP 库存盘点单表';
...
CREATE TABLE `erp_stock_check_item`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'ERP 库存盘点项表';
...
CREATE TABLE `erp_stock_in`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'ERP 其它入库单表';
...
CREATE TABLE `erp_stock_in_item`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'ERP 其它入库单项表';
...
CREATE TABLE `erp_stock_move`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'ERP 库存调拨单表';
...
CREATE TABLE `erp_stock_move_item`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'ERP 库存盘点项表';
...
CREATE TABLE `erp_stock_out`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'ERP 其它入库单表';
...
CREATE TABLE `erp_stock_out_item`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'ERP 其它出库单项表';
...
CREATE TABLE `erp_stock_record`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 41 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'ERP 产品库存明细表';
