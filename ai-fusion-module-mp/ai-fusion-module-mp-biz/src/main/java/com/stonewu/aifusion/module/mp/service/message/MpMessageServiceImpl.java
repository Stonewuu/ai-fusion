package com.stonewu.aifusion.module.mp.service.message;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.StrUtil;
import com.stonewu.aifusion.framework.common.pojo.PageResult;
import com.stonewu.aifusion.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import com.stonewu.aifusion.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import com.stonewu.aifusion.module.mp.convert.message.MpMessageConvert;
import com.stonewu.aifusion.module.mp.dal.dataobject.account.MpAccountDO;
import com.stonewu.aifusion.module.mp.dal.dataobject.message.MpMessageDO;
import com.stonewu.aifusion.module.mp.dal.dataobject.user.MpUserDO;
import com.stonewu.aifusion.module.mp.dal.mysql.message.MpMessageMapper;
import com.stonewu.aifusion.module.mp.enums.message.MpMessageSendFromEnum;
import com.stonewu.aifusion.module.mp.framework.mp.core.MpServiceFactory;
import com.stonewu.aifusion.module.mp.framework.mp.core.util.MpUtils;
import com.stonewu.aifusion.module.mp.service.account.MpAccountService;
import com.stonewu.aifusion.module.mp.service.material.MpMaterialService;
import com.stonewu.aifusion.module.mp.service.message.bo.MpMessageSendOutReqBO;
import com.stonewu.aifusion.module.mp.service.user.MpUserService;
...
import static com.stonewu.aifusion.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
