package com.stonewu.aifusion.module.mp.controller.admin.menu.vo;
...
import static com.stonewu.aifusion.module.mp.framework.mp.core.util.MpUtils.*;
...
public class MpMenuBaseVO {
    ...
    @Schema(description = "网页链接", example = "https://www.stonewu.com/")
    ...
    @Schema(description = "回复的音乐链接", example = "https://www.stonewu.com/xxx.mp3")
    ...
    @Schema(description = "高质量音乐链接", example = "https://www.stonewu.com/xxx.mp3")
