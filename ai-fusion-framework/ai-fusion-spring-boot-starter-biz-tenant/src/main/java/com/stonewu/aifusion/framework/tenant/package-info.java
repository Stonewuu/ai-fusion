 ...
 *      1）Spring Async：
 *          {@link com.stonewu.aifusion.framework.quartz.config.AiFusionAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 AiFusionSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.stonewu.aifusion.framework.tenant;
