...
import com.stonewu.aifusion.framework.tracer.core.aop.BizTraceAspect;
import com.stonewu.aifusion.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "aifusion.tracer", value = "enable", matchIfMissing = true)
public class AiFusionTracerAutoConfiguration {
