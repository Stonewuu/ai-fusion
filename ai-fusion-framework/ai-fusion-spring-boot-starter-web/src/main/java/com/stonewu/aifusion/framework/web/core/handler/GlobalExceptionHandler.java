package com.stonewu.aifusion.framework.web.core.handler;
...
import static com.stonewu.aifusion.framework.common.exception.enums.GlobalErrorCodeConstants.*;
...
public class GlobalExceptionHandler {
    ...
    public CommonResult<?> noResourceFoundExceptionHandler(HttpServletRequest req, NoResourceFoundException ex) {
    ...
    private CommonResult<?> handleTableNotExists(Throwable ex) {
        ...
        if (message.contains("mp_")) {
            ...
            return CommonResult.error(NOT_IMPLEMENTED.getCode(),
                    "[微信公众号 ai-fusion-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
        }
        // 4. 商城系统
        if (StrUtil.containsAny(message, "product_", "promotion_", "trade_")) {
            log.error("[商城系统 ai-fusion-module-mall - 已禁用][参考 https://doc.iocoder.cn/mall/build/ 开启]");
            return CommonResult.error(NOT_IMPLEMENTED.getCode(),
        ...
        if (message.contains("erp_")) {
            ...
            return CommonResult.error(NOT_IMPLEMENTED.getCode(),
                    "[ERP 系统 ai-fusion-module-erp - 表结构未导入][参考 https://doc.iocoder.cn/erp/build/ 开启]");
        }
        // 6. CRM 系统
        ...
        if (message.contains("pay_")) {
            ...
            return CommonResult.error(NOT_IMPLEMENTED.getCode(),
                    "[支付模块 ai-fusion-module-pay - 表结构未导入][参考 https://doc.iocoder.cn/pay/build/ 开启]");
        }
        return null;
    }
