package com.stonewu.aifusion.framework.desensitize.core;
...
import com.stonewu.aifusion.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.stonewu.aifusion.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.stonewu.aifusion.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("AiFusion");
        ...
        desensitizeDemo.setRegex("你好，我是AiFusion");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("AiFusion");
        ...
        assertEquals("AiFusion", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "AiFusion", replacer = "*")
