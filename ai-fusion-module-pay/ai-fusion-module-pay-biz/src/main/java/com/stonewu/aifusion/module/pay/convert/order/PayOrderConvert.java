package com.stonewu.aifusion.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, com.stonewu.aifusion.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
