...
import com.stonewu.aifusion.module.pay.service.refund.PayRefundServiceImpl;
...
public class PayNotifyServiceTest extends BaseDbUnitTest {
    ...
    public void testCreatePayNotifyTask_order() {
        PayNotifyServiceImpl payNotifyService = Mockito.mock(PayNotifyServiceImpl.class);
