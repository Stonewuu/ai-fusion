package com.stonewu.aifusion.module.pay.service.refund;
...
import com.stonewu.aifusion.module.pay.dal.mysql.refund.PayRefundMapper;
...
public class PayRefundServiceTest extends BaseDbAndRedisUnitTest {
    ...
    public void testCreateRefund_invokeSuccess() {
        PayRefundServiceImpl payRefundServiceImpl = Mockito.mock(PayRefundServiceImpl.class);
